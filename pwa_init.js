...
(function() {
    ...
    if ('serviceWorker' in navigator) {
        window.addEventListener('load', function() {
            navigator.serviceWorker.register('sw.js?v=579.00', { scope: './', updateViaCache: 'none' })
                .then(function(registration) {
                    // Forzar comprobación inmediata de actualización
                    registration.update();
                    console.log('[PWA Medical] Service Worker registrado con éxito (v579). Scope:', registration.scope);
