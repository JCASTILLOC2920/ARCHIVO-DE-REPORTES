...
(function() {
    ...
    if ('serviceWorker' in navigator) {
        window.addEventListener('load', function() {
            navigator.serviceWorker.register('sw.js?v=584.00', { scope: './', updateViaCache: 'none' })
                .then(function(registration) {
                    // Forzar comprobación inmediata de actualización
                    registration.update();
                    console.log('[PWA Medical] Service Worker registrado con éxito (v584). Scope:', registration.scope);
