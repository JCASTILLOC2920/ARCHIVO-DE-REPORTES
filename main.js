...
import { initDictaphone, startDictation } from './dictaphone_core.js?v=4.20';
import { initReportEditorLogic, populateEditorModal } from './ui_report_editor.js?v=4.20';
import { initAdminUI, populateModalDoctorsSelect } from './ui_admin.js?v=4.20';
