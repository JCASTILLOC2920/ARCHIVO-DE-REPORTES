...
import { initLocalDatabases, patientDatabase, loadDoctorsData, doctorsDatabase, categoriesDatabase, templatesDatabase, triggerAutomaticBackup, syncPatientsFromSupabase, subscribePatientsRealtime, savePatient, deletePatient, updateSyncStatusUI, fetchFullPatientDetails } from './db_service.js?v=3.58';
import { initTableUI, renderTable, applyFilters, setCurrentService } from './ui_tables.js?v=3.58';
import { initModalListeners, openModal, closeModal } from './ui_editor.js?v=3.58';
import { openPrintWindow } from './pdf_engine.js?v=3.58';
import { initDictaphone, startDictation } from './dictaphone_core.js?v=3.58';
import { initReportEditorLogic, populateEditorModal } from './ui_report_editor.js?v=3.58';
import { initAdminUI, populateModalDoctorsSelect } from './ui_admin.js?v=3.58';
