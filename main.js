...
import { initReportEditorLogic, populateEditorModal } from './ui_report_editor.js?v=580.00';
...
import { openMobileReportReader, closeMobileReportReader } from './mobile_report_reader.js?v=580.00';
import { initClientSimulator, openClientSimulatorModal, switchToClient, exitClientSimulation } from './client_simulator.js?v=580.00';
import { initGroqCopilot, openGroqCopilotModal } from './groq_copilot.js?v=580.00';
