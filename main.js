...
import { initLocalDatabases, patientDatabase, loadDoctorsData, doctorsDatabase, categoriesDatabase, templatesDatabase, sortPatientArray, triggerAutomaticBackup, syncPatientsFromSupabase, syncTemplatesFromSupabase, syncCategoriesFromSupabase, subscribePatientsRealtime, savePatient, deletePatient, updateSyncStatusUI, fetchFullPatientDetails, processSyncQueue } from './db_service.js?v=20.00';
import { initTableUI, renderTable, applyFilters, setCurrentService } from './ui_tables.js?v=20.00';
import { initModalListeners, openModal, closeModal } from './ui_editor.js?v=20.00';
import { openPrintWindow } from './pdf_engine.js?v=20.00';
import { initDictaphone, startDictation } from './dictaphone_core.js?v=20.00';
import { initReportEditorLogic, populateEditorModal } from './ui_report_editor.js?v=20.00';
import { initAdminUI, populateModalDoctorsSelect } from './ui_admin.js?v=20.00';
